...
#https://parzibyte.me/blog/2020/04/23/sumar-restar-fechas-python/
...
ruta_profeParqueados = "profe_parqueaderos.json"
...
def bienvenida():
    ...
    #no funciona 
    print("\n########################################################")
    print(Back.BLUE, "Bienvenido al Sistema de Parqueo Universidad Javeriana", Back.RESET)
    print("########################################################")
    print("\n1. Registrar usuario",
...
def registro():
    ...
    for x in range(len(datos['usuarios'])):
        ...
        if(datos['usuarios'][x][1]==ingreso[1]):
            ...
            print("\n\n#########################################################",
                  "\nLa Identificacion del usuario ya esta en la base de datos",
...
def alteraciones():
    #print("\033[2J\033[1;1f") #Comando borrar pantalla
    print("\n\n#######################################")
    print(Back.WHITE,"Bienvenido al sistema de Alteraciones",Back.RESET)
    print("#######################################")
    print("\n1. Alterar usuario",
          "\n2. Borrar usuario"
          "\n3. Volver")
    ...
    if(seleccion == 1):
        datos = archivo_usuarios_r()
        identificacion = int(input("Digite la Identificacion del usuario a ser alterado: "))
    ...
    #BORRAR       
        ...
        datos = archivo_usuarios_r()    
        identificacion = int(input("Digite la Identificacion del usuario a ser borrado: "))
...
def usar_servicio():
    #print("\033[2J\033[1;1f") #Comando borrar pantalla
    print("\n\n######################################")
    print(Back.CYAN,"Bienvenido al sistema de Parqueadero",Back.RESET)
    print("######################################")
    ...
    for x in range(len(datos['usuarios'])):
        ...
        if(datos['usuarios'][x][1]==identificacion):
            ...
            print(encontrado)
            print("\n------------------------------------------",
                  "\nBienvenido:", Back.GREEN,datos['usuarios'][x][0],Back.RESET,"!!!",
                  "\n------------------------------------------")
...
#Funcion reporte: geenrar reportes
def reporte():
    #print("\033[2J\033[1;1f") #Comando borrar pantalla
    print("\n\n####################################")
    print("Bienvenido al sistema de generacion de reportes")
    print("####################################")
    print("Los reportes consisten en el estado actual del estacionamiento",
          "\n1. Reporte por catidad de vehiculos",
          "\n2. Reporte por tipo de vehiculo",
          "\n3. Reporte por Porcentaje ocupacion",
          "\n4. Volver")
    seleccion = eval(input("\nElija una opción: "))  
...
def administrador():
    #print("\033[2J\033[1;1f") #Comando borrar pantalla
    print("\n\n#########################################")
    print(Back.BLACK,"Bienvenido al sistema de administracion",Back.RESET)
    print("#########################################")
...
def parquear_carro(usuario):
    ...
    for p in range(1,7):  #para cada numero de pisos establecemos contadores
        ...
        #todos los pisos tienen 10 columnas excepto piso 6
    ...
    #INTENTO DE PUBLICAR COLORES DISPONIBLES
    ...
    #USO DE: DATETIME https://parzibyte.me/blog/2020/04/23/sumar-restar-fechas-python/
    #FECHA REAL
    ahora = datetime.now()
    ...
    print(tabulate([[registro[0],registro[2],registro[4]]], headers, tablefmt="grid"))
...
def retirar_carro(usuario):
    #Funcion para retirar el carro del estacionamiento

    archivo = archivo_parqueados_r(ruta_parqueados)
    pisos = archivo_pisos_r()
    
    for x in range (len(archivo['Parqueados'])):
        if (archivo['Parqueados'][x][0] == usuario[1]):
            ...
            print("\n\n\n","Informacion de control:",
                  ...
                  "\n  Fecha de llegada (DD/MM/AAAA HH:MM:SS-> 24H):", archivo['Parqueados'][x][2],
                  "\n\n")            
            ...
            #PARA MENSUALIDAD ELIMINA Y SOBRESCRIBE DATOS A EXCEPCION DEL REGISTRO  
            if usuario[5]==1:
                print()
                ...
                print()
                print(Back.GREEN,"Procedimiento completado!!!",Back.RESET,
                      "\n",
                      )
                                
                return
        
            #PARA DIARIO IGUAL QUE MENSUALIDAD Y REALIZA EL PAGO
            elif usuario[5]==2:
                ...
                minutos = int(input("Digite el numero de minutos que estubo en el parqueadero: "))
                pago_minutos = 0
                ...
                for x in range(minutos):
                    ...
                    if(delete_parqueados[6] == 1):
                        ...
                        if pago_minutos%60 == 0:    
                            pago_tipo_usuario = pago_tipo_usuario + 1000
                        
                    elif(delete_parqueados[6] == 2):
                        pago_minutos = pago_minutos + 1
                        
                        if pago_minutos%60 == 0:
                            pago_tipo_usuario = pago_tipo_usuario + 2000
                        
                    elif(delete_parqueados[6] == 3):
                        pago_minutos = pago_minutos + 1
                        if pago_minutos%60 == 0:
                            pago_tipo_usuario = pago_tipo_usuario + 1500
                ...
                #USO DE: DATETIME Y TIMEDELTA https://parzibyte.me/blog/2020/04/23/sumar-restar-fechas-python/
                #PARA CONVERTIR STRING A DATATIME https://j2logo.com/operaciones-con-fechas-en-python/
                fecha_entrada = datetime.strptime(delete_parqueados[2], '%Y-%m-%d %H:%M:%S.%f')
                fecha_salida = fecha_entrada + timedelta(minutes=minutos)
                ...
                print("\nSu usuario quedara guardado en la base de datos, puede usar la opcion Alterar/Borrar Usuario",
                      "\n""\n""\n",
                      Back.GREEN,"Procedimiento completado!!!",Back.RESET)
                return
...
#verificacion si archivo existe y verifica si esta vacio (if)
...
#Lectura del archivo JSON PISOS -> logica identica
def archivo_pisos_r():
    try:
